-- CreateEnum
CREATE TYPE "LeaveStatus" AS ENUM ('PENDING_TEACHER', 'PENDING_HOD', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "LeaveKind" AS ENUM ('LEAVE', 'OD');

-- CreateEnum
CREATE TYPE "AttendanceStatus" AS ENUM ('PRESENT', 'ABSENT', 'OD', 'EXCUSED');

-- CreateEnum
CREATE TYPE "AuditSource" AS ENUM ('WEB', 'MOBILE', 'SYSTEM');
...
-- CreateIndex
CREATE UNIQUE INDEX "Class_departmentId_name_key" ON "Class"("departmentId", "name");
...
-- CreateIndex
CREATE INDEX "TeacherAssignment_departmentId_idx" ON "TeacherAssignment"("departmentId");

-- CreateIndex
CREATE INDEX "TeacherAssignment_academicYearId_idx" ON "TeacherAssignment"("academicYearId");

-- CreateIndex
CREATE UNIQUE INDEX "TeacherAssignment_teacherId_sectionId_academicYearId_key" ON "TeacherAssignment"("teacherId", "sectionId", "academicYearId");
